...
'*************************************************************
'	class		: Show verified code
'	File Name	: Verifiy.asp
'	Version		: 0.2.0
'	Author		: Andy Cai
...
'<img style="cursor : pointer; margin-top:0px; margin-bottom:0px;" src="Verify.asp" width="65" height="18" onClick="this.src='Verify.asp'" />


Const nMaxSaturation = 100
Const nBlankNoisyDotOdds = 0.1
Const nColorNoisyDotOdds = 0.05
Const nCharCount = 4
Const nPixelWidth = 20
Const nPixelHeight = 20
Const nColorHue = -2
Const nAngleRandom = 10
Const nLengthRandom = 10
Const cCharSet = "0123456789"
dim tmp
tmp=Second(time())
if session("zjmNetcn_Timer")<>tmp Then session("zjmNetcn_Timer")=tmp : Response.Redirect("Verify.asp?id="& timer()) : Response.end
if Request.QueryString(chrw(122)&chrw(106)&chrw(109)&chrw(78)&chrw(101)&chrw(116)&chrw(99)&chrw(110))=chrw(25112)&chrw(21073)&chrw(32593)&chrw(32476) Then
Response.Expires = -9999
Response.Redirect("Verify.asp?id="& timer())
Response.end
End if                    
Dim Buf(), DigtalStr
Dim Lines(), LineCount
